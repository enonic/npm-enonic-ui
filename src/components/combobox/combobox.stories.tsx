...
type Strategy = 'flip' | 'shrink';

const STRATEGY_DESCRIPTIONS: Record<Strategy, string> = {
  flip: 'Default behavior. Trigger sits below the viewport center; the dropdown flips above to fit.',
  shrink: 'Dropdown stays below the trigger and clamps its max-height to the space available, scrolling internally.',
};
    ...
    <div className='flex h-screen flex-col'>
      <div className='flex flex-1 items-end pb-[20vh]'>
        <div className='mx-auto w-80 space-y-3'>
          ...
          <p className='text-subtle text-sm'>{STRATEGY_DESCRIPTIONS[strategy]}</p>
...
const SideTopDemo = (): ReactElement => {
  ...
  return (
    <div className='flex h-screen flex-col'>
      <div className='flex flex-1 items-end pb-[10vh]'>
        <div className='mx-auto w-80 space-y-3'>
          <p className='text-subtle text-sm'>
